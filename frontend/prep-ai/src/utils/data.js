export const CARD_BG = [
  ...
  { id: 4, bgcolor: 'linear-gradient(135deg, #fff2e9 0%, #fff6f3 100%)' },
...
export const APP_FEATURES = [
  ...
  {
    id: "05",
    title: "Save, Organize & Track",
    description:
      "Improve your preparation with curated questions and structured learning paths designed for real interviews.",
  },
  {
    id: "06",
    title: "AI Resume Reviewer",
    description:
      "Get instant formatting feedback, ATS optimization strategies, and actionable improvements for your PDF resume.",
  },
];